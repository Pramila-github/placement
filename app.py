...
def main():
    st.markdown("<h1 style ='color:green; text_align:center;font-family:times new roman;font-weight: bold;font-size:25pt;'>STUDENT PLACEMENT PREDICTION⭐ </h1>", unsafe_allow_html=True)  
